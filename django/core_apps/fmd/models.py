...
class FMD(TimeStampedModel):
    ...
    letzte_untersuchung =  models.CharField(verbose_name=_("Letzte Untersuchung"))
    leistungstest =  models.CharField(verbose_name=_("Leistungstest"))
    naechste_untersuchung =  models.IntegerField(verbose_name=_("Nächste Untersuchung"), max_length=4)
