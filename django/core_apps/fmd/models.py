...
class FMD(TimeStampedModel):
    ...
    letzte_untersuchung =  models.DateField(verbose_name=_("Letzte Untersuchung"), max_length=10, blank=True)
    leistungstest =  models.CharField(verbose_name=_("Leistungstest"), max_length=255, blank=True)
    naechste_untersuchung =  models.IntegerField(verbose_name=_("Nächste Untersuchung"), blank=True)
    ...
    fdisk_aenderung =  models.DateField(verbose_name=_("FDISK Änderung"), max_length=10, blank=True)
